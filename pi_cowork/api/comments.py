...
from pi_cowork.models import get_comments, add_comment
...
def api_add_comment(ticket_id):
    ...
    add_log('INFO', 'db_change', f'INSERT comments/{comment_id}', details={'operation': 'INSERT', 'table': 'comments', 'record_id': comment_id}, ticket_id=ticket_id)
