...
from pi_cowork.events import QUESTION_ANSWERED, QUESTION_ASKED, bus
from pi_cowork.models import add_comment, count_unanswered_questions, get_agent, get_questions, get_status
...
def api_create_questions(ticket_id):
    ...
    for q in questions:
        ...
        cur = run_db(
            "INSERT INTO questions (ticket_id, body, options) VALUES (?, ?, ?)", (ticket_id, body, options_str)
        )
    ...
    for qid in ids:
        add_log(
            "INFO",
            "db_change",
            f"INSERT questions/{qid}",
            details={"operation": "INSERT", "table": "questions", "record_id": qid},
            ticket_id=ticket_id,
        )
...
def api_answer_question(question_id):
    ...
    add_log(
        ...
        details={"operation": "DELETE", "table": "questions", "record_id": question_id},
        ticket_id=ticket_id,
    )
...
def api_batch_answer(ticket_id):
    ...
    for qid in answered_ids:
        ...
        add_log(
            "INFO",
            "db_change",
            f"DELETE questions/{qid}",
            details={"operation": "DELETE", "table": "questions", "record_id": qid},
            ticket_id=ticket_id,
        )
