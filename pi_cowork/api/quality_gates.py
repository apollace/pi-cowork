...
def api_create_quality_gate():
    ...
    try:
        ...
        add_log(
            "INFO",
            "db_change",
            f"INSERT quality_gates/{cur.lastrowid}",
            details={"operation": "INSERT", "table": "quality_gates", "record_id": cur.lastrowid},
        )
...
def api_update_quality_gate(gate_id):
    ...
    add_log(
        "INFO",
        "db_change",
        f"UPDATE quality_gates/{gate_id}",
        details={"operation": "UPDATE", "table": "quality_gates", "record_id": gate_id},
    )
...
def api_delete_quality_gate(gate_id):
    ...
    add_log(
        "INFO",
        "db_change",
        f"DELETE quality_gates/{gate_id}",
        details={"operation": "DELETE", "table": "quality_gates", "record_id": gate_id},
    )
    return jsonify({"success": True})
