...
class TestKillBtnCss:
    ...
    def test_kill_btn_has_danger_soft_background(self):
        ...
        assert 'var(--danger-soft)' in body, (
            f'Expected background: var(--danger-soft) in .kill-btn, got:\n{body}'
        )
    ...
    def test_kill_btn_text_color_is_dark_red(self):
        ...
        assert '#991b1b' in body, (
            f'Expected color: #991b1b in .kill-btn, got:\n{body}'
        )
    ...
    def test_kill_btn_hover_fills_solid_red(self):
        ...
        body = m.group(1)
        assert 'var(--danger)' in body or '#ef4444' in body, (
            f'Expected solid danger background on hover, got:\n{body}'
        )
    ...
    def test_danger_btn_still_solid_red(self):
        ...
        assert 'var(--danger)' in body, (
            f'Expected solid var(--danger) background in .btn.danger, got:\n{body}'
        )
...
class TestKillBtnHtml:
    ...
    def test_run_live_kill_btn_has_kill_btn_class(self):
        ...
        assert 'btn kill-btn' in html, (
            f'Expected "btn kill-btn" in run_live.html'
        )
    ...
    def test_ticket_detail_kill_btn_uses_kill_btn_not_danger(self):
        ...
        assert m, (
            'Expected class="btn small kill-btn" for kill button in ticket_detail.html'
        )
    ...
    def test_appjs_kill_btn_class(self):
        ...
        js = read(APP_JS_PATH)
        assert 'class="kill-btn"' in js, (
            'Expected kill-btn class on kill button in app.js'
        )
    ...
    def test_run_live_kill_btn_not_only_danger(self):
        ...
        if kill_btn_match:
            ...
            assert 'kill-btn' in classes, (
                f'Kill button should have kill-btn class: {classes}'
            )