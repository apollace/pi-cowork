...
class TestAssistantPanelZIndex:
    ...
    def test_assistant_panel_open_z_index(self):
        ...
        assert "z-index: 250" in body, f"Expected 'z-index: 250' in .assistant-panel.open, got:\n{body}"
    ...
    def test_assistant_panel_base_z_index(self):
        ...
        body = m.group(1)
        assert "z-index: 200" in body, f"Expected 'z-index: 200' in base .assistant-panel, got:\n{body}"
    ...
    def test_assistant_bubble_z_index(self):
        ...
        assert "z-index: 201" in body, f"Expected 'z-index: 201' in .assistant-bubble, got:\n{body}"
    ...
    def test_z_index_hierarchy(self):
        ...
        assert panel_z > bubble_z, (
            f".assistant-panel.open z-index ({panel_z}) must be > .assistant-bubble z-index ({bubble_z})"
        )
    ...
    def test_board_assistant_panel_open_z_index(self):
        ...
        if not m:
            ...
            return
        body = m.group(1)
        assert "z-index: 250" in body, f"Expected 'z-index: 250' in .board-assistant-panel.open, got:\n{body}"
    ...
    def test_board_assistant_bubble_z_index(self):
        ...
        if not m:
            ...
            return
        body = m.group(1)
        assert "z-index: 201" in body, f"Expected 'z-index: 201' in .board-assistant-bubble, got:\n{body}"
